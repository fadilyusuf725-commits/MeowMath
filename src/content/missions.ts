...
export const missions: readonly MissionDefinition[] = [
  {
    ...
    shortTitle: 'Kenalan dulu',
    tpCode: 'Kenalan dulu',
    objective: 'Mio ingin mengenal cara berpikirmu sebelum kita mulai berkeliling kota.',
    story: 'Kita ketuk pintu Kota Meow bersama. Tidak perlu takut salah; jawabanmu membantu Mio menemanimu dengan lebih baik.',
    color: 'yellow',
    icon: '🐾',
    challenges: [
      {
  ...
  },
  {
    ...
    number: 1,
    title: 'Pencari Kotak',
    shortTitle: 'Cari bentuknya',
    tpCode: 'TP-1',
    objective: 'Mengenali mana bentuk datar, mana bangun ruang, dan membedakan kubus dari balok.',
    story: 'Mio sedang memilih kotak untuk membawa bahan bangunan. Temani ia mencari bentuk yang paling pas.',
    color: 'coral',
    icon: '📦',
    challenges: [
      {
  ...
  },
  {
    ...
    shortTitle: 'Lihat cirinya',
    tpCode: 'TP-2',
    objective: 'Menemukan bidang, rusuk, titik sudut, dan perbedaan kubus serta balok.',
    story: 'Beberapa label bangunan tertukar. Pasang telinga dan mata detektifmu, lalu bantu Mio memeriksanya.',
    color: 'teal',
    icon: '🔎',
    challenges: [
      {
  ...
  },
  {
    ...
    number: 3,
    title: 'Bengkel Blok',
    shortTitle: 'Susun bloknya',
    tpCode: 'TP-3 & TP-4',
    objective: 'Membangun dan membongkar bentuk dengan blok satuan.',
    story: 'Blok-blok sudah datang! Yuk, bantu Mio membuat bangunan yang kokoh dan rapi.',
    color: 'purple',
    icon: '🧱',
    challenges: [
      {
      ...
      },
      {
        type: 'build',
        id: 'b-2',
        prompt: 'Ada satu blok yang terselip. Pindahkan sampai susunannya sama seperti gambar Mio.',
        target: lStructure,
  ...
  },
  {
    ...
    shortTitle: 'Lihat tiga arah',
    tpCode: 'TP-5',
    objective: 'Melihat satu bangunan dari depan, atas, dan samping.',
    story: 'Mio punya denah, tetapi gambar 3D-nya hilang. Bantu ia membayangkan menara dari tiga arah.',
    color: 'blue',
    icon: '👁️',
    challenges: [
      {
  ...
  },
  {
    ...
    shortTitle: 'Bangun kotanya',
    tpCode: 'TP-6',
    objective: 'Menggabungkan idemu dan menemukan tempat yang tepat di peta.',
    story: 'Kota Meow hampir selesai! Bantu Mio menata bangunan agar semua kucing mudah menemukan jalannya.',
    color: 'green',
    icon: '🏙️',
    challenges: [
      {
